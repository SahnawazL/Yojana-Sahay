...
export const GUJARAT_SCHEMES = [

  {
    ...
    annual: 500000,
    apply:   { en: "https://www.bajajfinserv.in/insurance/mukhyamantri-amrutum-scheme", hi: "health.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 80000,
    apply:   { en: "https://www.myscheme.gov.in/schemes/mksy", hi: "ikhedut.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 4000,
    apply:   { en: "https://wcd.gujarat.gov.in/posts?id=305", hi: "wcd.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 0,
    apply:   { en: "https://sje.gujarat.gov.in/gntdnt/Women-affluence-scheme", hi: "mmuy.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 15000,
    apply:   { en: "https://wcd.gujarat.gov.in/initiativedetails?id=231", hi: "esamajkalyan.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 150000,
    apply:   { en: "https://sje.gujarat.gov.in/ddcw/Pandit-Din-Dayal-Upadhyay-Awas-Yojana-Housing-Scheme?lang=english", hi: "gramnirman.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 70000,
    apply:   { en: "https://macrofinance.nipfp.org.in/PDF/10_Sugoor_Micro_Irrigation_in_Gujarat.pdf", hi: "ikhedut.gujarat.gov.in" }, applyType: "online",
    docs:    { en: ["Aadhaar Card", "Land Records (7/12 Utara)", "Bank Passbook", "Caste Certificate (if SC/ST)", "Photo"],
               hi: ["आधार कार्ड", "जमीन के कागज़ (7/12 उतारा)", "बैंक पासबुक", "जाति प्रमाण (SC/ST के लिए)", "फोटो"] },
...

  {
    ...
    annual: 50000,
    apply:   { en: "https://www.myscheme.gov.in/schemes/ascfsrguj", hi: "fisheries.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 100000,
    apply:   { en: "https://www.myscheme.gov.in/schemes/vdy", hi: "esamajkalyan.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 20000,
    apply:   { en: "https://www.myscheme.gov.in/schemes/kssugbocwwb", hi: "bocwwb.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 0,
    apply:   { en: "https://www.suratmunicipal.gov.in/Departments/LIGHousing", hi: "ghb.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 0,
    apply:   { en: "https://seedfund.startupindia.gov.in/portfolio", hi: "icreate.org.in" }, applyType: "online",
...

  {
    ...
    annual: 40000,
    apply:   { en: "https://suryagujarat.guvnl.in/apply-rooftop-pv-solar", hi: "https://guvnl.in" }, applyType: "online",
...

  {
    ...
    annual: 40000,
    apply:   { en: "https://www.mittigoldorganic.com/blog/gujarat-government-subsidy-organic-farming", hi: "agri.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 500000,
    apply:   { en: "https://www.myscheme.gov.in/schemes/ma", hi: "maavcard.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 60000,
    apply:   { en: "https://www.myscheme.gov.in/schemes/sfvptphdf", hi: "agri.gujarat.gov.in" }, applyType: "online",
    docs:    { en: ["Aadhaar Card", "Land Records (7/12 Utara)", "Bank Passbook", "Caste Certificate (if SC/ST)", "Photo"],
               hi: ["आधार कार्ड", "जमीन के कागज़ (7/12 उतारा)", "बैंक पासबुक", "जाति प्रमाण (SC/ST के लिए)", "फोटो"] },
    match: (a) => a.state === "Gujarat" && a.who === "farmer",
  },

  {
    ...
    annual: 45000,
    apply:   { en: "https://agri.gujarat.gov.in/Home/SchemesDetailsPage?Id=P+wk1phXMF7evIxDtQJ2YQ==&domain=o4rkgGvkhO9IQUTkb5zosA==", hi: "ikhedut.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 0,
    apply:   { en: "https://msmeloans.in/aif-agriculture-infrastructure-fund-for-cold-storage", hi: "agriinfra.dac.gov.in / agri.gujarat.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 0,
    apply:   { en: "https://www.myscheme.gov.in/schemes/elgmfdcl", hi: "gujaratminority.gov.in" }, applyType: "online",
