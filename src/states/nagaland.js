...
export const NAGALAND_SCHEMES = [
...

  {
    ...
    annual: 400000,
    apply:   { en: "https://health.nagaland.gov.in", hi: "health.nagaland.gov.in / निकटतम सूचीबद्ध अस्पताल आयुष्मान डेस्क" }, applyType: "online",
...

  {
    ...
    annual: 22000,
    apply:   { en: "https://dhe.nagaland.gov.in", hi: "dhe.nagaland.gov.in / स्कूल या कॉलेज कार्यालय (ऑनलाइन + ऑफलाइन)" }, applyType: "online",
