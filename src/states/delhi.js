...
export const DELHI_SCHEMES = [
...

  {
    ...
    annual: 12000,
    apply:   { en: "wcd.delhi.gov.in", hi: "wcd.delhi.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 0,
    apply:   { en: "pmay-uday.delhi.gov.in", hi: "pmay-uday.delhi.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 12000,
    apply:   { en: "scholarships.delhi.gov.in", hi: "scholarships.delhi.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 6000,
    apply:   { en: "labourcis.delhi.gov.in", hi: "labourcis.delhi.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 0,
    apply:   { en: "dscstfdc.in", hi: "dscstfdc.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Education", hi: "शिक्षा" },
    annual: 20000,
    apply:   { en: "scstwelfare.delhi.gov.in", hi: "scstwelfare.delhi.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 500000,
    apply:   { en: "health.delhi.gov.in/ayushman", hi: "health.delhi.gov.in/ayushman" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Employment", hi: "रोजगार" },
    annual: 9000,
    apply:   { en: "dtte.delhi.gov.in", hi: "dtte.delhi.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 600,
    apply:   { en: "delhi.gov.in/doorstep", hi: "delhi.gov.in/doorstep" }, applyType: "online",
...

  {
    ...
    annual: 30000,
    apply:   { en: "ev.delhi.gov.in", hi: "ev.delhi.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Education", hi: "शिक्षा" },
    annual: 11000,
    apply:   { en: "minorities.delhi.gov.in", hi: "minorities.delhi.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Entrepreneurship", hi: "उद्यमिता" },
    annual: 0,
    apply:   { en: "startup.delhi.gov.in", hi: "startup.delhi.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 0,
    apply:   { en: "dillikiyogshala.com", hi: "dillikiyogshala.com" }, applyType: "online",
