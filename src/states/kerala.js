...
export const KERALA_SCHEMES = [
...

  {
    ...
    tag:     { en: "Education", hi: "शिक्षा" },
    annual: 8000,
    apply:   { en: "dcescholarship.kerala.gov.in", hi: "dcescholarship.kerala.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Education", hi: "शिक्षा" },
    annual: 0,
    apply:   { en: "asapkerala.gov.in", hi: "asapkerala.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Education", hi: "शिक्षा" },
    annual: 15000,
    apply:   { en: "minoritywelfare.kerala.gov.in", hi: "minoritywelfare.kerala.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Education", hi: "शिक्षा" },
    annual: 1000000,
    apply:   { en: "hed.kerala.gov.in", hi: "hed.kerala.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Social Welfare", hi: "सामाजिक कल्याण" },
    annual: 200000,
    apply:   { en: "cmdrf.kerala.gov.in", hi: "cmdrf.kerala.gov.in" }, applyType: "online",
