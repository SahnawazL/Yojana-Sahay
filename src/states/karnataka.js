...
export const KARNATAKA_SCHEMES = [
...

  {
    ...
    annual: 4000,
    apply:   { en: "https://www.myscheme.gov.in/search/state/Karnataka", hi: "raitamitra.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 0,
    apply:   { en: "https://www.manage.gov.in/fpoacademy/SGSchemes/karnataka.pdf", hi: "ahvs.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 175000,
    apply:   { en: "https://www.bajajfinserv.in/karnataka-housing-board-scheme", hi: "rgjrhcl.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    annual: 500000,
    apply:   { en: "https://www.india.gov.in/category/health-wellness/subcategory/health-resources/details/arogya-karnataka-scheme-karnataka", hi: "karunadu.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 0,
    apply:   { en: "https://www.myscheme.gov.in/schemes/isfsr", hi: "seridept.karnataka.gov.in" }, applyType: "online",
    docs:    { en: ["Aadhaar Card", "Land Records (RTC)", "Bank Account", "Photo"],
               hi: ["आधार कार्ड", "जमीन के कागज़ (RTC)", "बैंक खाता", "फोटो"] },
    match: (a) => a.state === "Karnataka" && a.who === "farmer" && a.area === "rural",
  },

  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 0,
    apply:   { en: "https://www.myscheme.gov.in/schemes/midh", hi: "horticulture.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Health", hi: "स्वास्थ्य" },
    annual: 250000,
    apply:   { en: "https://www.bajajfinserv.in/insurance/yeshasvini-health-insurance-scheme", hi: "karnataka.gov.in/yashasvini" }, applyType: "online",
...

  {
    ...
    annual: 0,
    apply:   { en: "https://cag.gov.in/webroot/uploads/download_audit_report/2025/PA-on-Welfare-of-Building-and-Other-Construction-workers-in-Karnataka-English-068a5aa5c9a9f80.37316414.pdf", hi: "labour.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Business", hi: "व्यापार" },
    annual: 0,
    apply:   { en: "https://web.umang.gov.in/landing/scheme/detail/udyogini-scheme_us.html", hi: "kwdc.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Health", hi: "स्वास्थ्य" },
    annual: 500000,
    apply:   { en: "https://www.india.gov.in/category/health-wellness/subcategory/health-care-promotion-products/details/forms-by-suvarna-arogya-suraksha-trust-karnataka", hi: "karunadu.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 0,
    apply:   { en: "https://fisheries.kerala.gov.in/sites/default/files/inline-files/4%20KARNATAKA.pdf", hi: "fisheries.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Business", hi: "व्यापार" },
    annual: 0,
    apply:   { en: "https://www.myscheme.gov.in/schemes/nhdpccwms", hi: "handloom.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 0,
    apply:   { en: "https://en.vikaspedia.in/viewcontent/energy/policy-support/state-wise/karnataka-surya-raitha-scheme?lgn=en", hi: "bescom.org / kredl.kar.nic.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "General", hi: "सामान्य" },
    annual: 60000,
    apply:   { en: "https://www.india.gov.in/services/details/application-for-sports-scholarship-karnataka", hi: "yas.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Housing", hi: "आवास" },
    annual: 0,
    apply:   { en: "https://cag.gov.in/uploads/download_audit_report/2014/Karnataka_housing_sector_6_2014_chapter_8.pdf", hi: "khb.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Labour", hi: "श्रमिक" },
    annual: 0,
    apply:   { en: "https://www.govtschemes.in/karnataka-swavalambi-sarathi-scheme", hi: "labour.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 0,
    apply:   { en: "https://pmksy.mowr.gov.in", hi: "raitamitra.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Labour", hi: "श्रमिक" },
    annual: 0,
    apply:   { en: "https://www.myscheme.gov.in", hi: "labour.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "General", hi: "सामान्य" },
    annual: 12000,
    apply:   { en: "https://clpr.org.in/blog/the-uneven-implementation-of-welfare-schemes-for-transgender-persons-part-ii-access-to-karnataka-government-schemes", hi: "sevasindhu.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Business", hi: "व्यापार" },
    annual: 0,
    apply:   { en: "https://www.startupindia.gov.in/srf/portal/SRF_2026_Result_page/Karnataka_State_Report.pdf", hi: "startup.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 0,
    apply:   { en: "https://ssbexim.com/cold-storage", hi: "horticulture.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "Business", hi: "व्यापार" },
    annual: 0,
    apply:   { en: "https://investkarnataka.co.in/wp-content/uploads/2026/04/Karnataka.pdf", hi: "udyamimitra.in / कर्नाटक उद्योग मित्र पोर्टल" }, applyType: "online",
