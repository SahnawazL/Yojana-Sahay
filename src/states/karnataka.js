...
export const KARNATAKA_SCHEMES = [
...

  {
    ...
    tag:     { en: "Farmer", hi: "किसान" },
    annual: 0,
    apply:   { en: "https://subsistencefarming.in/en/paramparagat-krishi-vikas-yojana-guide", hi: "raitamitra.karnataka.gov.in" }, applyType: "online",
...

  {
    ...
    tag:     { en: "General", hi: "सामान्य" },
    annual: 12000,
    apply:   { en: "https://depwd.gov.in/en/national-handicapped-finance-and-development-corporation", hi: "sevasindhu.karnataka.gov.in" }, applyType: "online",
