...
export const TRIPURA_SCHEMES = [
...

  {
    ...
    annual: 4000,
    apply:   { en: "https://pmkisan.gov.in/rpt_beneficiarystatus_pub.aspx", hi: "agri.tripura.gov.in / निकटतम ब्लॉक कृषि अधिकारी" }, applyType: "online",
...

  {
    ...
    annual: 500000,
    apply:   { en: "https://www.myscheme.gov.in/schemes/tjhis", hi: "health.tripura.gov.in / सूचीबद्ध अस्पताल में निकटतम आयुष्मान मित्र" }, applyType: "online",
