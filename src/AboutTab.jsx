...
const STRINGS = {
  en: {
    ...
    privacyEyebrow: "YOUR DATA & RIGHTS",
    privacyIntro:
  ...
  hi: {
    ...
    privacyEyebrow: "आपका डेटा और अधिकार",
    privacyIntro:
...
export default function AboutTab({ onClose, citizensGuided = null }) {
  ...
  // ── Android hardware back button — push a history entry on mount so the
  //    system back gesture has something to pop instead of closing the app.
  //    popstate fires when the user presses back; we intercept it and call
  //    onClose to return to the app normally.
  useEffect(() => {
    window.history.pushState({ ysAbout: true }, "");
