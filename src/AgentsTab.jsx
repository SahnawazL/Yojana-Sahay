...
function buildAttendanceReportHTML({ report, payConfigs, preparedBy = "" }) {
  ...
  // ── Logo watermark — YojanaSahay logo (WebP 180px, 8 KB base64).
...
<style>
  ...
  * { box-sizing: border-box; }
  ...
  /* ── Logo watermark — YojanaSahay logo, B&W ghost-seal, centered ────────
     grayscale(100%) converts the full-colour logo to pure B&W.
     opacity(0.08) fades it to 8% — visible but never distracting.
     position:fixed + every-page print behaviour same as body::before. ── */
  body::after {
    content: "";
    position: fixed;
    top: 38%;
